...
#     ABSTRACT_FROM => q[lib/Business/ES/NIF.pm]
#     AUTHOR => [q[Harun Delgado <trycky@gmail.com>]]
...
DISTVNAME = Business-ES-NIF-0.01
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract:           The great new Business::ES::NIF!' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Harun Delgado <trycky@gmail.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new Business::ES::NIF!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Harun Delgado &lt;trycky@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
